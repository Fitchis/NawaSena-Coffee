    ...
    <section id="tentang" className="py-16 bg-background">
      <div className="w-full max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-3">Fasilitas & Keunggulan</h2>
          <p className="text-lg text-foreground/70">Mengapa memilih NawaSena Cafe</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="border-border bg-card hover:shadow-lg transition-shadow text-center">
                <CardHeader className="pb-3">
                  <div className={`w-16 h-16 rounded-lg ${feature.bgColor} flex items-center justify-center mx-auto mb-3`}>
